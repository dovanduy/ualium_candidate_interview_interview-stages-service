                ...
                */
                try
                {
                    using (var connection = new SqlConnection(InterviewStagesServiceDbContext.Connectionstring.GetConnection))
                    {
                        ...
                        insertInterviewStageCmd.Parameters.AddWithValue("WhenAcceptedUtc", context.Message.WhenDeclinedUtc);
                        ...
                        insertInterviewCmd.Parameters.AddWithValue("InterviewStatusEnum", 2);
                        insertInterviewCmd.Parameters.AddWithValue("WhenInterviewCompleted", context.Message.WhenDeclinedUtc);
